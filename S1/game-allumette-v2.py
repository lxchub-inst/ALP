...
def game_allumette():
    allu_depart = random.choice([ALLU_DEPART_16, ALLU_DEPART_4]) # On choisit un nombre d'allumettes au hasard entre 4 et 16
    nom_joueurs = ["Joueur 1", "Ordinateur 1"] # On crée une liste avec les noms des joueurs
