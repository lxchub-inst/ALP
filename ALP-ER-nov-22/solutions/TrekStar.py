...
def recap(parcours, nom): 
    ...
    if d_parcourue == DIST_TOT_TREK:
        ...
        if est_en_course:
            ...
            print("Il reste",distance_restante(d_parcourue),"km qui devraient être parcourus en",nombre_de_jours_restants(parcours),"jour(s) s'il maintient sa moyenne qui est de",v_moyenne,"km par jour")
        else:
