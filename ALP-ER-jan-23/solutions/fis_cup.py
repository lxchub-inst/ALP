...
def afficher_moyenne_placements(nom_skieuse):
    print("Moyenne des placements de", nom_skieuse, "à la position", DIC_NOMS[nom_skieuse], ":",
          moyenne_placements(DIC_NOMS[nom_skieuse]))
...
def question4():
    ...
    print("Nombre de points qui la séparent de la deuxième place:",
          dic_points_skieuses[num_leader] - dic_points_skieuses[num_second])
